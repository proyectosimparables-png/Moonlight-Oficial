...
export function CategoriaTreeSelector({ categorias, value = [], onChange }: Props) {
      ...
      <div key={cat.id} className="flex flex-col">
        <label
          className={clsx(
            ...
            value.includes(cat.id) ? "bg-purple-50/80 font-semibold text-purple-800" : "text-gray-700"
          )}
